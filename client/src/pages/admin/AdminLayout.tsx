...
export const MENU_PERMISSION_MAP: Record<string, string[]> = {
  ...
  '/admin/presentation': ['view_reports'],
...
export default function AdminLayout({ children }: { children: React.ReactNode }) {
  ...
  const getBadgeCount = (href: string): number => {
    ...
    const unifiedPaymentsTotal = (pendingCounts.pendingDeposits || 0) + (pendingCounts.pendingCryptoPayments || 0) + (pendingCounts.pendingPhysicalDeposits || 0);
    const countMap: Record<string, number> = {
      ...
      '/admin/physical-deposits': pendingCounts.pendingPhysicalDeposits || 0,
  ...
  const menuSections = [
    ...
    },
    {
      ...
      items: [
        ...
        { label: 'Official Presentation', href: '/admin/presentation' },
