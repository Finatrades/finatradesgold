      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        ...
        >
          ...
          <h2 className="text-4xl lg:text-6xl font-bold mb-8 flex items-center justify-center gap-4 flex-wrap">
            ...
            <span className="text-slate-900 dark:text-white dark:text-white">Swiss Financial </span>
            <span className="text-purple-600 dark:text-purple-400">Standards</span>
          </h2>
          
          <p className="text-slate-700 dark:text-slate-300 dark:text-slate-300 text-xl mb-10 max-w-3xl mx-auto leading-relaxed font-medium">
