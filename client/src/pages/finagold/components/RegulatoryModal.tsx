      ...
      <DialogContent className="max-w-4xl max-h-[90vh] p-0 overflow-hidden">
        <DialogHeader className="p-6 pb-4 border-b bg-gradient-to-r from-purple-50 to-pink-50">
          <div className="flex items-center gap-3">
            ...
            <div>
              <DialogTitle className="text-2xl font-bold text-foreground">Trusted & Regulated</DialogTitle>
              <p className="text-muted-foreground">Complete Regulatory and Legal Information</p>
            </div>
          </div>
        </DialogHeader>
        ...
        <ScrollArea className="h-[calc(90vh-120px)]">
          <div className="p-6 space-y-8">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="font-medium text-foreground">Finatrades Finance SA</p>
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="font-medium text-foreground">Rue Robert-CÉARD 6, 1204, GENEVA</p>
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    <MapPin className="w-5 h-5 text-purple-500 mt-0.5" />
                    <div>
                      ...
                      <p className="font-medium text-foreground">GENEVA</p>
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    <Hash className="w-5 h-5 text-purple-500 mt-0.5" />
                    <div>
                      <p className="text-sm text-muted-foreground">Company Number (UID)</p>
                      <p className="font-medium text-foreground">CHE-422.960.092</p>
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    <Hash className="w-5 h-5 text-purple-500 mt-0.5" />
                    <div>
                      <p className="text-sm text-muted-foreground">LEI Number</p>
                      <a 
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="font-medium text-foreground">FNFNCHG2</p>
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    <Calendar className="w-5 h-5 text-purple-500 mt-0.5" />
                    <div>
                      <p className="text-sm text-muted-foreground">Date of Formation</p>
                      <p className="font-medium text-foreground">29.01.2019</p>
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    <FileCheck className="w-5 h-5 text-purple-500 mt-0.5" />
                    <div>
                      <p className="text-sm text-muted-foreground">Type of Corporation</p>
                      <p className="font-medium text-foreground">Société Anonyme LLC</p>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <section>
              ...
              <div className="bg-gradient-to-br from-purple-50 to-pink-50 rounded-xl p-6 border border-purple-100">
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <span className="text-muted-foreground">Regulatory Supervision</span>
                </div>
                <p className="text-lg font-semibold text-foreground mb-4">SO-FIT Member No.: 1186</p>
            ...
            <section>
              ...
              <div className="bg-muted/40 rounded-xl p-6">
                <h4 className="font-semibold text-foreground mb-4">Comprehensive AML Compliance Statement</h4>
                ...
                <p className="text-foreground/85 mb-4">Finatrades' AML & CFT Compliance Program, approved by the Management Board, includes:</p>
                
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="bg-card rounded-lg p-4 border border-border">
                    <h5 className="font-semibold text-foreground mb-2">Customer Due Diligence (CDD)</h5>
                    <p className="text-sm text-muted-foreground">Mandatory identity verification of all customers and beneficial owners, including documentation of source of funds and purpose of transactions.</p>
                  </div>
                  <div className="bg-card rounded-lg p-4 border border-border">
                    <h5 className="font-semibold text-foreground mb-2">Enhanced Due Diligence (EDD)</h5>
                    <p className="text-sm text-muted-foreground">Additional scrutiny for Politically Exposed Persons (PEPs), high-risk jurisdictions, and complex structures.</p>
                  </div>
                  <div className="bg-card rounded-lg p-4 border border-border">
                    <h5 className="font-semibold text-foreground mb-2">Ongoing Monitoring</h5>
                    <p className="text-sm text-muted-foreground">Continuous review of transactions to detect and report unusual or suspicious activity.</p>
                  </div>
                  <div className="bg-card rounded-lg p-4 border border-border">
                    <h5 className="font-semibold text-foreground mb-2">Record Retention</h5>
                    <p className="text-sm text-muted-foreground">Secure storage of customer and transaction records for the statutory retention period.</p>
                  </div>
                  <div className="bg-card rounded-lg p-4 border border-border">
                    <h5 className="font-semibold text-foreground mb-2">Employee Training</h5>
                    <p className="text-sm text-muted-foreground">Regular AML/CFT training for all relevant employees to ensure understanding of regulatory obligations.</p>
                  </div>
                  <div className="bg-card rounded-lg p-4 border border-border">
                    <h5 className="font-semibold text-foreground mb-2">Risk-Based Approach</h5>
                    <p className="text-sm text-muted-foreground">Application of the Wolfsberg Principles and other international best practices for risk classification and monitoring.</p>
                  </div>
                </div>
