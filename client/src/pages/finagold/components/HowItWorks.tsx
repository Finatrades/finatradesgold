    ...
    >
      ...
      >
        <step.icon className={`w-6 h-6 md:w-8 md:h-8 transition-colors duration-500 ${
          isActive || isCompleted ? 'text-[#8A2BE2]' : 'text-slate-600 dark:text-slate-400'
        }`} />
      ...
      >
        <div className="flex items-center gap-2 md:gap-3 mb-2">
          <span className={`text-xs md:text-sm font-bold transition-colors duration-500 ${
            isActive ? 'text-[#8A2BE2]' : 'text-slate-700 dark:text-slate-300'
          }`}>
            Step {step.number}
          </span>
        ...
        <h3 className={`text-base md:text-lg font-semibold mb-1 md:mb-2 transition-colors duration-500 ${
          isActive || isCompleted ? 'text-[#0D0D0D]' : 'text-slate-700 dark:text-slate-300'
        }`}>
          {step.title}
        </h3>
        <p className={`text-xs md:text-sm leading-relaxed transition-colors duration-500 ${
          isActive ? 'text-slate-700 dark:text-slate-300' : 'text-slate-700 dark:text-slate-300'
        }`}>
          {step.description}
        </p>
      </motion.div>
