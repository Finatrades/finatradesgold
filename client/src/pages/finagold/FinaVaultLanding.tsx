        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          >
            <motion.div
              ...
              className="relative p-8 rounded-2xl bg-card border border-border/60 shadow-xl"
            >
    ...
    <section className="relative py-32 bg-gradient-to-b from-[#FAFBFF] via-white to-[#F8F9FC] overflow-hidden">
      <div className="relative max-w-5xl mx-auto px-6">
        ...
        <motion.div
          ...
          whileInView={{ opacity: 1, y: 0 }}
          viewport={{ once: true }}
          className="p-8 rounded-2xl bg-card border border-border/60 shadow-xl"
        >
          ...
          <div className="mt-8 h-32 rounded-xl bg-muted/40 p-4">
