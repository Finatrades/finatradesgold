    ...
    <section className="relative min-h-[90vh] flex items-center py-24 overflow-hidden">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 w-full">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          {/* Trade Flow Animation - Right Side */}
          <motion.div
            initial={{ opacity: 0, x: 30 }}
            animate={{ opacity: 1, x: 0 }}
          ...
          >
            <div className="relative rounded-2xl overflow-hidden bg-white/80 backdrop-blur-sm border border-gray-200 shadow-xl p-4">
              <div className="relative h-[280px] w-full">
                ...
                >
                  ...
                  {/* Top curved path */}
                  <motion.path
                    d="M 40 100 Q 120 30, 200 50 Q 280 70, 360 100"
                    fill="none"
                  ...
                  {/* Bottom curved path */}
                  <motion.path
                    d="M 360 100 Q 280 170, 200 150 Q 120 130, 40 100"
                    fill="none"
                  ...
                  <motion.g initial={{ scale: 0, opacity: 0 }} animate={{ scale: 1, opacity: 1 }} transition={{ delay: 0.3 }}>
                    <circle cx="40" cy="100" r="20" fill="white" stroke="url(#heroTopPathGradient)" strokeWidth="2" />
                  </motion.g>
                  
                  {/* FinaBridge hub */}
                  <motion.g initial={{ scale: 0, opacity: 0 }} animate={{ scale: 1, opacity: 1 }} transition={{ delay: 0.5 }}>
                    <circle cx="200" cy="100" r="28" fill="white" stroke="url(#heroTopPathGradient)" strokeWidth="2" />
                    <motion.circle cx="200" cy="100" r="32" fill="none" stroke="#8A2BE2" strokeWidth="1" opacity="0.3"
                  ...
                  {/* Exporter node */}
                  <motion.g initial={{ scale: 0, opacity: 0 }} animate={{ scale: 1, opacity: 1 }} transition={{ delay: 0.3 }}>
                    <circle cx="360" cy="100" r="20" fill="white" stroke="url(#heroBottomPathGradient)" strokeWidth="2" />
                  </motion.g>
                </svg>
                ...
                <div className="absolute bottom-2 left-0 right-0 flex justify-between px-4">
                  ...
                  <span className="text-gray-600 text-xs font-medium">FinaBridge</span>
