  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
      ...
      <motion.div
        ...
        transition={{ duration: 0.2 }}
      >
        <Card className="p-5 bg-white border-l-4 border-l-purple-500 shadow-sm hover:shadow-md transition-shadow">
          <div className="flex items-center justify-between mb-4">
            <div className="flex items-center gap-2">
            ...
            <span className="text-xs text-fuchsia-600 font-medium bg-purple-50 px-2 py-1 rounded-full">
              Coming Soon
            </span>
          </div>
          ...
          <div className="flex gap-6 pt-3 border-t border-border">
            <div>
              ...
              <p className="text-sm font-semibold text-fuchsia-600">Not Activated</p>
            </div>
            <div>
