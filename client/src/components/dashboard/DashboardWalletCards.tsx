...
import { Wallet, CreditCard, TrendingUp, ArrowRight, Lock } from 'lucide-react';
...
export default function DashboardWalletCards({ finaPayWallet, bnslData, userName = 'User' }: DashboardWalletCardsProps) {
  return (
    <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
      ...
      <Card className="p-5 bg-white border border-gray-100 shadow-sm hover:shadow-md transition-shadow">
        <div className="flex items-center justify-between mb-4">
          ...
          <Link href="/finapay">
            <span className="text-sm text-emerald-600 hover:text-emerald-700 flex items-center gap-1 cursor-pointer">
      ...
      <Card className="p-5 bg-white border border-gray-100 shadow-sm hover:shadow-md transition-shadow">
        <div className="flex items-center justify-between mb-4">
          ...
          <Link href="/bnsl">
            <span className="text-sm text-purple-600 hover:text-purple-700 flex items-center gap-1 cursor-pointer">
              View <ArrowRight className="w-3 h-3" />
            </span>
          </Link>
        </div>
