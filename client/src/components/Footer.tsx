      ...
      <div className="container mx-auto px-6 py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
            ...
            <div className="flex gap-3">
              <a href="#" className="block" data-testid="link-app-store">
                <div className="bg-black rounded-lg px-4 py-2 flex items-center gap-2 border border-gray-700 hover:border-gray-500 transition-colors">
                  ...
                  <div className="text-left">
                    <div className="text-[10px] text-muted-foreground/70">Download on the</div>
              ...
              <a href="#" className="block" data-testid="link-google-play">
                <div className="bg-black rounded-lg px-4 py-2 flex items-center gap-2 border border-gray-700 hover:border-gray-500 transition-colors">
                  ...
                  <div className="text-left">
                    <div className="text-[10px] text-muted-foreground/70">GET IT ON</div>
              ...
              {quickLinks.map((link) => (
                <li key={link.label}>
                  <button
                    ...
                    className="text-muted-foreground/70 hover:text-purple-500 transition-colors text-sm"
          ...
          <div>
            ...
            <ul className="space-y-3">
              {legalLinks.map((link) => (
                <li key={link.label}>
                  <Link href={link.href}>
                    <span className="text-muted-foreground/70 hover:text-purple-500 transition-colors text-sm cursor-pointer" data-testid={`footer-link-${link.label.toLowerCase().replace(/\s+/g, '-')}`}>
                      {link.label}
                    </span>
                  </Link>
                </li>
          ...
          <div>
            ...
            <ul className="space-y-3 text-muted-foreground/70 text-sm">
              <li>
        ...
        <div className="border-t border-gray-800 mt-12 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            <p className="text-muted-foreground text-sm" data-testid="text-copyright">
              © 2025 Finatrades Finance SA. All rights reserved.
            </p>
            <div className="flex flex-col items-center md:items-end gap-3">
              <div className="text-muted-foreground/70 text-sm text-center md:text-right">
