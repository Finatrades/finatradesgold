...
export default function Footer() {
  ...
  return (
    <footer className="bg-[#0D001E] text-white" data-testid="footer">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
              ...
              {quickLinks.map((link) => (
                <li key={link.label}>
                  <button
                    ...
                    className="text-gray-400 hover:text-[#E91E8C] transition-colors text-sm"
          ...
          <div>
            ...
            <ul className="space-y-3">
              {legalLinks.map((link) => (
                <li key={link.label}>
                  <Link href={link.href}>
                    <span className="text-gray-400 hover:text-[#E91E8C] transition-colors text-sm cursor-pointer" data-testid={`footer-link-${link.label.toLowerCase().replace(/\s+/g, '-')}`}>
                      {link.label}
                    </span>
                  </Link>
                </li>
          ...
          <div>
            ...
            <ul className="space-y-3 text-gray-400 text-sm">
              ...
              <li>
                <a href="mailto:contact@finatrades.com" className="hover:text-[#E91E8C] transition-colors">
        ...
        <div className="border-t border-gray-800 mt-12 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            ...
            <div className="flex items-center gap-6">
              <a href="#" className="text-gray-500 hover:text-[#E91E8C] transition-colors">
