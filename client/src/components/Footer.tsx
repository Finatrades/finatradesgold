        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
          ...
          <div>
            ...
            <ul className="space-y-3">
              {legalLinks.map((link) => (
                <li key={link.label}>
                  <Link href={link.href}>
                    <span className="text-gray-400 hover:text-orange-500 transition-colors text-sm cursor-pointer" data-testid={`footer-link-${link.label.toLowerCase().replace(/\s+/g, '-')}`}>
                      {link.label}
                    </span>
                  </Link>
                </li>
          ...
          <div>
            ...
            <ul className="space-y-3 text-gray-400 text-sm">
              ...
              <li>
                <a href="mailto:contact@finatrades.com" className="hover:text-orange-500 transition-colors">
