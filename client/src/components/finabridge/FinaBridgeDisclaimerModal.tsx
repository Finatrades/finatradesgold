      ...
      <Dialog open={open} onOpenChange={() => {}}>
        <DialogContent className="w-[95vw] max-w-4xl max-h-[85vh] p-0 flex flex-col [&>button]:hidden" onPointerDownOutside={(e) => e.preventDefault()} onEscapeKeyDown={(e) => e.preventDefault()}>
          ...
          <ScrollArea className="flex-1 min-h-0 h-[calc(85vh-200px)] overflow-y-auto">
            <div className="prose prose-sm max-w-none text-foreground/85 px-6 py-4">
              <h2 className="text-lg font-bold text-foreground mb-4">1. Introduction</h2>
              ...
              <h2 className="text-lg font-bold text-foreground mb-4">2. Role of Finatrades</h2>
              ...
              <h2 className="text-lg font-bold text-foreground mb-4">3. Trade Settlement Through Gold</h2>
              ...
              <h3 className="text-md font-bold text-foreground mb-2">3.5. Gold Locking Mechanism & Conditional Release</h3>
              ...
              <h2 className="text-lg font-bold text-foreground mb-4">4. Exporter Settlement Options</h2>
              ...
              <h2 className="text-lg font-bold text-foreground mb-4">5. Gold Handling and Custody</h2>
              ...
              <h2 className="text-lg font-bold text-foreground mb-4">6. Compliance and KYC/AML Requirements</h2>
              ...
              <h2 className="text-lg font-bold text-foreground mb-4">7. Fee Allocation and Responsibility</h2>
              ...
              <h2 className="text-lg font-bold text-foreground mb-4">8. No Responsibility for Commercial Disputes</h2>
              ...
              <h2 className="text-lg font-bold text-foreground mb-4">9. Platform Fees</h2>
              ...
              <h2 className="text-lg font-bold text-foreground mb-4">10. Electronic Instructions and Records</h2>
              ...
              <h2 className="text-lg font-bold text-foreground mb-4">11. Liability and Limitations</h2>
              ...
              <h2 className="text-lg font-bold text-foreground mb-4">12. Sanctions, Restricted Products & Prohibited Origins</h2>
              ...
              <h2 className="text-lg font-bold text-foreground mb-4">13. Governing Law</h2>
              ...
              <h2 className="text-lg font-bold text-foreground mb-4">14. Acceptance</h2>
          ...
          <div className="p-6 pt-4 border-t bg-muted/40">
            <Button 
              onClick={() => setShowFullTerms(false)}
            ...
            <div className="space-y-3 text-sm text-foreground/85">
              ...
              <div className="space-y-2">
                <div className="p-3 bg-muted/40 rounded-lg border border-border">
                  <h4 className="font-semibold text-foreground mb-1 text-sm">Sanctions & Trade Restrictions</h4>
                ...
                <div className="p-3 bg-muted/40 rounded-lg border border-border">
                  <h4 className="font-semibold text-foreground mb-1 text-sm">Restricted Jurisdictions</h4>
                  <div className="flex flex-wrap gap-1 mt-2">
                    ...
                    <span className="px-1.5 py-0.5 bg-muted text-muted-foreground text-[10px] rounded-full">+more</span>
                  </div>
                </div>
                ...
                <div className="p-3 bg-muted/40 rounded-lg border border-border">
                  <h4 className="font-semibold text-foreground mb-1 text-sm">Violations & Consequences</h4>
                  <p className="text-xs text-muted-foreground">
                ...
                <div className="p-3 bg-muted/40 rounded-lg border border-border">
                  <h4 className="font-semibold text-foreground mb-1 text-sm">Your Responsibility</h4>
                  <p className="text-xs text-muted-foreground">
                ...
                <div className="p-3 bg-muted/40 rounded-lg border border-border">
                  <h4 className="font-semibold text-foreground mb-1 text-sm">Liability Exclusion</h4>
                  <p className="text-xs text-muted-foreground">
                ...
                <div className="p-3 bg-muted/40 rounded-lg border border-border">
                  <h4 className="font-semibold text-foreground mb-1 text-sm">Right to Reject</h4>
                  <p className="text-xs text-muted-foreground">
          ...
          <div className="w-full md:w-[380px] flex-shrink-0 overflow-y-auto p-4 bg-muted/40 flex flex-col">
            <div className="space-y-4 flex-1">
              <div className="p-4 bg-blue-50 rounded-lg border border-blue-200">
                ...
                <RadioGroup 
                  ...
                  className="space-y-2"
                >
                  <div className="flex items-center space-x-3 p-3 bg-card rounded-lg border border-blue-100 hover:border-blue-300 transition-colors">
            ...
            <div className="mt-4 pt-4 border-t border-border space-y-3">
              <div className="flex items-start gap-3 p-3 bg-card rounded-lg border border-border">
                ...
                />
                <label htmlFor="accept-terms" className="text-xs text-foreground/85 cursor-pointer leading-relaxed">
