...
export default function HowItWorks() {
  ...
  return (
    <section id="how-it-works" className="py-24 bg-gradient-to-br from-white via-purple-50/20 to-pink-50/20 relative overflow-hidden">
      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        >
          <span className="inline-block px-4 py-2 rounded-full bg-gradient-to-r from-[#EC4899]/10 to-[#9333EA]/10 border border-[#EC4899]/20 text-sm font-semibold text-[#9333EA] uppercase tracking-wider mb-6">
            {accountType === 'business' ? 'ENTERPRISE WORKFLOW' : 'PERSONAL WORKFLOW'}
          </span>
          <h2 className="text-3xl lg:text-5xl font-bold mb-4">
            <span className="text-gray-900">How It </span>
            <span className="bg-gradient-to-r from-[#9333EA] to-[#EC4899] bg-clip-text text-transparent">Works</span>
          </h2>
