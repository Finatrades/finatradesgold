  ...
  switch (certificate.type) {
    ...
    case 'Physical Storage':
      return {
        ...
        issuerName: 'Wingold and Metals DMCC',
        certificationText: 'has the following gold holdings in secure physical storage:',
        footerText: 'This certificate confirms physical storage of the specified gold in secure vault facilities managed by Wingold and Metals DMCC.'
      };
