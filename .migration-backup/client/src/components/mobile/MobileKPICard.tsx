...
const gradientStyles = {
  purple: {
    ...
    border: 'border-purple-200 dark:border-purple-800/40/50',
  ...
  amber: {
    bg: 'bg-card/80 backdrop-blur-xl',
    border: 'border-amber-200 dark:border-amber-800/40/50',
  ...
  emerald: {
    bg: 'bg-card/80 backdrop-blur-xl',
    border: 'border-emerald-200 dark:border-emerald-800/40/50',
  ...
  blue: {
    bg: 'bg-card/80 backdrop-blur-xl',
    border: 'border-blue-200 dark:border-blue-800/40/50',
  ...
  pink: {
    bg: 'bg-card/80 backdrop-blur-xl',
    border: 'border-pink-200 dark:border-pink-800/40/50',
  ...
  teal: {
    bg: 'bg-card/80 backdrop-blur-xl',
    border: 'border-teal-200 dark:border-teal-800/40/50',
